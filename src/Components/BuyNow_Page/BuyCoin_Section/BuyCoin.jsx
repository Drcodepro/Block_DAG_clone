    ...
    <div className="BuyCoin_Section_Container">
        <div className="BuyCoin_Container">
            <div className="BuyCoin_info">
                <h1>Join BlockDAG Network, Connect & Contribute</h1>
                <p>Explore the BlockDAG ecosystem at your own pace. Join effortlessly using your crypto wallet, credit or debit cards, Apple Pay, or Google Pay. Become a valued member of our community and embrace the simplicity of connection today.</p>

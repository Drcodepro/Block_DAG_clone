    ...
    <div className="learn_now_page_container">
        ...
        <div className="more_info_container">
            <div className="more_info_head">
                <h1>Welcome to the heart of the BlockDAG Network – our Tokenomics.</h1>
        ...
        <div className="end_content">
            ...
            <p>The team—our core driving force—is allocated this portion. Demonstrating our long-term vision, these coins are locked for 2 years. It's our way of saying we're in this for the long haul, fully invested in the success of BlockDAG.Conclusion

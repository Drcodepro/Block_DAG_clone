    ...
    <div className="Home_footer_section">
      <div className="footer_mainContent">
        <div className="Home_footer_info">
          ...
          <p>
            BlockDAG is a Layer 1 proof of work consensus mechanism that evolves
        ...
        <div className="footer_rights"><p>Copyright © BlockDAG Disclaimer: Cryptocurrency may be unregulated in your jurisdiction. The value of cryptocurrencies may fluctuate. Profits may be subject to capital gains or other taxes applicable in your jurisdiction
           </p>
        </div>
    </div>
  );

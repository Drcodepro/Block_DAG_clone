...
return () => {
    ...
    return (<div className="Tokenomics_Section_Container">
        ...
        <h2 className="another_heading">BlockDAG coin (BDAG) has a supply of 150 billion coins, a testament to its exclusivity and value preservation.</h2>
        ...
        <div className="graph_Details_container">
            ...
            <div className="first_graph">
                ...
                <p>With 98.5 billion coins set aside, BlockDAG prioritizes its community, rewarding miners and funding initiatives for a robust ecosystem and seamless trading experience. This allocation represents our commitment to everyone who uses, promotes, and sees BlockDAG’s potential.</p>
            </div>
            ...
            <div className="third_graph">
                ...
                <p>We dedicate 1.5 billion coins to our team, locked to align with BlockDAG's long-term goals, showcasing our commitment to project success and team motivation.</p>
            </div>
        </div>
